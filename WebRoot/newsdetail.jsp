...
<%
	...
	NewsInfoDto newsInfoDto = dbDao.getNewsInfoDto(newsId);

	String pageTitle = newsInfoDto.getTitle();
...
<div class="wapper clearfix overhide">
	<div class="subleft">
		<a id="menu01" class="on" href="dynamic.jsp">公司新闻</a>
	</div>
								...
								<tr>
									<td><strong
										style="color: rgb(15, 54, 83); font-weight: bolder;">
											...
											<%=newsInfoDto.getTitle()%></strong>&nbsp;&nbsp;<%=newsInfoDto.getCreateTime()%></td>
								</tr>
								<tr>
									<td style="color: rgb(123, 123, 123);"><BR>
										<p
											...
											<span
												style="color: gray; line-height: 200%; font-family: 宋体; font-size: 9pt; mso-bidi-font-size: 12.0pt; mso-bidi-font-family: Helvetica; mso-themecolor: background1; mso-themeshade: 128; mso-font-kerning: 0pt;">作者：<%=newsInfoDto.getAuthor()%><span
												lang="EN-US"><o:p></o:p></span></span>
										</p> <%
 	String[] paragraphs = PageUtil.getParagraphs(newsInfoDto
 			.getContent());
