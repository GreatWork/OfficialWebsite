...
<body>
    <form name="form1" method="post" action="notice.jsp" id="form1">
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTExMDk2MTgyMTMPZBYCAgMPZBYCAgMPD2QWAh4Hb25jbGljawUOd2luZG93LmNsb3NlKClkGAEFHl9fQ29udHJvbHNSZXF1aXJlUG9zdEJhY2tLZXlfXxYCBQZidG5ZZXMFBWJ0bk5vOV3XZ2E2kt4GfpEiSR2Bsabmxc4=" />
</div>

<div>

	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwKshKO0BwKLk41kAoGTreoJtyhCyH+DqpytSyArlZFRaO36boA=" />
</div>
    <div class="Container">
      <img src="img/notice.gif" width="952" height="176" />
...
本网站所载的资料于刊载日期属恰当充分，您在阅读时资料的准确性或完整性已发生变化。本网站刊登的所有资料可予以更改或修订而毋须事前通知，尽管重阳投资并不承诺定期更新本网站内容。公司并不对第三者所提供之有关资料的准确性、充足性或完整性作出任何保证，公司或其股东及雇员概不对于本网站内第三者所提供之资料的任何错误或遗漏负任何法律责任。<br /><br />
		...
		<div align="right">上海重阳投资管理有限公司</div>
            ...
            <input type="image" name="btnYes" id="btnYes" src="img/yes.gif" style="border-width:0px;" />&nbsp;<input type="image" name="btnNo" id="btnNo" src="img/no.gif" onclick="window.close();" style="border-width:0px;" />
          </div>
		</div>
    </form>
</body>
